...
var _here4$here4githubio$Msg$ViewSourceClick = function (a) {
	return {ctor: 'ViewSourceClick', _0: a};
};
var _here4$here4githubio$Msg$Toggle = function (a) {
	return {ctor: 'Toggle', _0: a};
};
var _here4$here4githubio$Msg$NewUrl = function (a) {
	return {ctor: 'NewUrl', _0: a};
};
var _here4$here4githubio$Msg$NavigateTo = function (a) {
	return {ctor: 'NavigateTo', _0: a};
};
var _here4$here4githubio$Msg$Snackbar = function (a) {
	return {ctor: 'Snackbar', _0: a};
};
var _here4$here4githubio$Msg$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};

var _here4$here4githubio$Route$urlFor = function (loc) {
	var _p0 = loc;
	return '/';
};
var _here4$here4githubio$Route$Home = {ctor: 'Home'};
var _here4$here4githubio$Route$pathParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_evancz$url_parser$UrlParser$map,
			_here4$here4githubio$Route$Home,
			_evancz$url_parser$UrlParser$s('')),
		_1: {ctor: '[]'}
	});
var _here4$here4githubio$Route$locFor = function (path) {
	return A2(_evancz$url_parser$UrlParser$parsePath, _here4$here4githubio$Route$pathParser, path);
};
var _here4$here4githubio$Route$init = function (location) {
	var _p1 = location;
	if (_p1.ctor === 'Nothing') {
		return {
			ctor: '::',
			_0: _elm_lang$core$Maybe$Just(_here4$here4githubio$Route$Home),
			_1: {ctor: '[]'}
		};
	} else {
		return {
...
var _here4$here4githubio$Model$initialModel = function (location) {
	return {
		mdl: _debois$elm_mdl$Material$model,
		snackbar: _debois$elm_mdl$Material_Snackbar$model,
		history: _here4$here4githubio$Route$init(location),
		toggles: _elm_lang$core$Dict$empty
	};
};
var _here4$here4githubio$Model$init = function (location) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_here4$here4githubio$Model$initialModel(
			_here4$here4githubio$Route$locFor(location)),
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material$init(_here4$here4githubio$Msg$Mdl),
			_1: {ctor: '[]'}
		});
};
var _here4$here4githubio$Model$Model = F4(
	function (a, b, c, d) {
		return {mdl: a, snackbar: b, history: c, toggles: d};
	});

var _here4$here4githubio$View_Home$textCard = F2(
...
var _here4$here4githubio$View_Home$textCell = F2(
	function (title, content) {
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_here4$here4githubio$View_Home$textCard, title, content),
				_1: {ctor: '[]'}
			});
	});
var _here4$here4githubio$View_Home$view = function (model) {
	return A2(
...
var _here4$here4githubio$View$viewBody = function (model) {
	var _p0 = A2(
		_elm_lang$core$Maybe$withDefault,
		_elm_lang$core$Maybe$Nothing,
		_elm_lang$core$List$head(model.history));
	if (_p0.ctor === 'Just') {
		return _here4$here4githubio$View_Home$view(model);
	} else {
		return _elm_lang$html$Html$text('404');
	}
};
var _here4$here4githubio$View$spacing = function (spc) {
	return {ctor: '_Tuple2', _0: 'letter-spacing', _1: spc};
};
var _here4$here4githubio$View$outline = function (color) {
	return {
		ctor: '_Tuple2',
		_0: 'text-shadow',
		_1: A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								color,
								A2(_elm_lang$core$Basics_ops['++'], ', -2px 0 0 ', color)))))))
	};
};
var _here4$here4githubio$View$viewHeader = function (model) {
	return A2(
		_debois$elm_mdl$Material_Layout$row,
		{
			...
			_1: {
				ctor: '::',
				_0: _debois$elm_mdl$Material_Color$text(
					A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Green, _debois$elm_mdl$Material_Color$S300)),
				_1: {
					ctor: '::',
					_0: A2(_debois$elm_mdl$Material_Options$css, 'align-items', 'center'),
					_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$h1,
						{
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: _here4$here4githubio$View$outline('#000'),
									_1: {
										ctor: '::',
										_0: _here4$here4githubio$View$spacing('2px'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Here4'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Layout$href('https://github.com/here4'),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Color$text(
											A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Green, _debois$elm_mdl$Material_Color$S700)),
										_1: {ctor: '[]'}
									}
								},
								{
...
var _here4$here4githubio$View$viewSubTitle = function (model) {
	return A2(
		_debois$elm_mdl$Material_Layout$row,
		{
			ctor: '::',
					...
					_0: A2(
						_elm_lang$html$Html$h4,
						{
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: _here4$here4githubio$View$outline('#555'),
									_1: {
										ctor: '::',
										_0: _here4$here4githubio$View$spacing('2px'),
										_1: {ctor: '[]'}
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Build 3D apps and the worlds they live in.'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _here4$here4githubio$View$view = function (model) {
	return _debois$elm_mdl$Material_Scheme$top(
		A4(
			_debois$elm_mdl$Material_Layout$render,
			_here4$here4githubio$Msg$Mdl,
			model.mdl,
			{
				ctor: '::',
			...
			},
			{
				header: {
					ctor: '::',
					_0: _here4$here4githubio$View$viewHeader(model),
					_1: {
						ctor: '::',
						_0: _here4$here4githubio$View$viewSubTitle(model),
						_1: {ctor: '[]'}
					}
				},
				drawer: {ctor: '[]'},
				...
				main: {
					ctor: '::',
					_0: _here4$here4githubio$View$viewBody(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$map,
							_here4$here4githubio$Msg$Snackbar,
...
var _here4$here4githubio$Ports$windowOpen = _elm_lang$core$Native_Platform.outgoingPort(
	'windowOpen',
	function (v) {
		return v;
	});

var _here4$here4githubio$Update$urlUpdate = F2(
...
var _here4$here4githubio$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _here4$here4githubio$Msg$Mdl, _p0._0, model);
			case 'Snackbar':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _here4$here4githubio$Msg$Snackbar, snackCmd),
						_1: {ctor: '[]'}
					});
			case 'NavigateTo':
				return A2(
					_here4$here4githubio$Update$urlUpdate,
					model,
					_here4$here4githubio$Route$locFor(_p0._0));
			case 'NewUrl':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
			...
			default:
				return A2(
					...
					{
						ctor: '::',
						_0: _here4$here4githubio$Ports$windowOpen(_p0._0),
						_1: {ctor: '[]'}
					});
		}
	});

var _here4$here4githubio$Subscriptions$subscriptions = function (model) {
	return A2(_debois$elm_mdl$Material$subscriptions, _here4$here4githubio$Msg$Mdl, model);
};

var _here4$here4githubio$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_here4$here4githubio$Msg$NavigateTo,
	{init: _here4$here4githubio$Model$init, update: _here4$here4githubio$Update$update, view: _here4$here4githubio$View$view, subscriptions: _here4$here4githubio$Subscriptions$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _here4$here4githubio$Main$main !== 'undefined') {
    _here4$here4githubio$Main$main(Elm['Main'], 'Main', undefined);
}
